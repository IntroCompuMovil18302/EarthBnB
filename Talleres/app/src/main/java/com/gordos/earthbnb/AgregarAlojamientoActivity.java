...
public class AgregarAlojamientoActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    // Variables locales
    private LatLng ubicacionAlojamientoLatLng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ubicacionAlojamientoLatLng = null;
        esFechaInicio = true;
        fechaInicio = -1;
        fechafin = -1;
    ...
    private boolean validateForm() {
        ...
        if (ubicacionAlojamientoLatLng == null) {
    ...
    private void agregarAlojamiento() {
        ...
        if (validateForm()) {
            ...
            nuevoAlojamiento.setLongitude(ubicacionAlojamientoLatLng.longitude);
